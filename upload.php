			...
			<div class="col-sm-8 col-sm-offset-2 text-center">
				<h3 class="text-primary">Upload Video</h3>
					<p>
						...
						<div class="alert text-center">After the file is uploaded we have to knit all chunks. This may take a couple of minutes. Please be patient when the upload is over 95%.<br /></div>
						<!-- Upload file listing -->
						<div id="uplist"></div>
					</p>
			</div>
